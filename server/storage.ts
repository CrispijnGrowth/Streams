...
export class MemStorage implements IStorage {
  ...
  private loadDummyData() {
    const streamsData = [
      { key: "STRM01", name: "Stream Alpha", phases: ["DESIGN", "MODERNIZATION & MIGRATION"], owners: ["Owner J"], labels: ["Priority:High", "Priority:Low", "Region:US"], momentumStatus: "Active", computedMilestoneDate: 46034 },
      { key: "STRM02", name: "Stream Beta", phases: ["MODERNIZATION & MIGRATION", "STRATEGY"], owners: ["Owner B", "Owner F"], labels: ["Priority:Low", "Region:US", "Region:EU"], momentumStatus: "Active", computedMilestoneDate: 46025 },
      { key: "STRM03", name: "Stream Gamma", phases: ["STRATEGY", "MODERNIZATION & MIGRATION"], owners: ["Owner K", "Owner I"], labels: ["Risk:Normal", "Priority:Low"], momentumStatus: "Active", computedMilestoneDate: 46142 },
      { key: "STRM04", name: "Stream Delta", phases: ["MODERNIZATION & MIGRATION"], owners: ["Owner C", "Owner A"], labels: ["Priority:Medium"], momentumStatus: "Stalled", computedMilestoneDate: 46041 },
      { key: "STRM05", name: "Stream Epsilon", phases: ["STRATEGY", "DESIGN"], owners: ["Owner E"], labels: ["Priority:Low", "Risk:Normal"], momentumStatus: "Active", computedMilestoneDate: 46148 },
      { key: "STRM06", name: "Stream Zeta", phases: ["MANAGE", "MODERNIZATION & MIGRATION"], owners: ["Owner J"], labels: ["Priority:Medium", "Risk:At-Risk", "Risk:Normal"], momentumStatus: "Stalled", computedMilestoneDate: 46200 },
      { key: "STRM07", name: "Stream Eta", phases: ["MODERNIZATION & MIGRATION", "DESIGN"], owners: ["Owner F"], labels: ["Region:EU", "Priority:High", "Risk:Normal"], momentumStatus: "Active", computedMilestoneDate: 46023 },
      { key: "STRM08", name: "Stream Theta", phases: ["DESIGN", "STRATEGY"], owners: ["Owner B", "Owner C"], labels: ["Priority:Medium", "Region:EU"], momentumStatus: "Active", computedMilestoneDate: 46026 },
      { key: "STRM09", name: "Stream Iota", phases: ["DESIGN", "MANAGE"], owners: ["Owner L"], labels: ["Region:EU", "Risk:Normal"], momentumStatus: "Active", computedMilestoneDate: 46072 },
    ];
    ...
    const deliverablesData = [
      { key: "DLV01-01", name: "Deliverable A1", streamKey: "STRM01", milestoneDate: 46387, phases: ["MODERNIZATION & MIGRATION"], owners: ["Owner D"], labels: ["Priority:Medium"], status: "Done", ordinal: 1 },
      { key: "DLV01-02", name: "Deliverable A2", streamKey: "STRM01", milestoneDate: 46240, phases: ["MODERNIZATION & MIGRATION"], owners: ["Owner B"], labels: ["Region:EU", "Risk:At-Risk"], status: "Executing", ordinal: 2 },
      { key: "DLV01-03", name: "Deliverable A3", streamKey: "STRM01", milestoneDate: 46283, phases: ["STRATEGY"], owners: ["Owner F"], labels: [], status: "Blocked", ordinal: 3 },
      { key: "DLV02-01", name: "Deliverable B1", streamKey: "STRM02", milestoneDate: 46373, phases: ["STRATEGY"], owners: ["Owner L"], labels: [], status: "To Execute", ordinal: 1 },
      { key: "DLV02-02", name: "Deliverable B2", streamKey: "STRM02", milestoneDate: 46344, phases: ["DESIGN"], owners: ["Owner L"], labels: ["Priority:Medium", "Region:US"], status: "Done", ordinal: 2 },
      { key: "DLV02-03", name: "Deliverable B3", streamKey: "STRM02", milestoneDate: 46025, phases: ["MODERNIZATION & MIGRATION"], owners: ["Owner H"], labels: [], status: "Backlog", ordinal: 3 },
      { key: "DLV03-01", name: "Deliverable C1", streamKey: "STRM03", milestoneDate: 46257, phases: ["DESIGN"], owners: ["Owner F"], labels: ["Region:EU"], status: "Executing", ordinal: 1 },
      { key: "DLV03-02", name: "Deliverable C2", streamKey: "STRM03", milestoneDate: 46142, phases: ["DESIGN"], owners: ["Owner E"], labels: [], status: "Executing", ordinal: 2 },
      { key: "DLV04-01", name: "Deliverable D1", streamKey: "STRM04", milestoneDate: 46231, phases: ["MODERNIZATION & MIGRATION"], owners: ["Owner E"], labels: ["Region:US", "Risk:Normal"], status: "Executing", ordinal: 1 },
      { key: "DLV04-02", name: "Deliverable D2", streamKey: "STRM04", milestoneDate: 46074, phases: ["MODERNIZATION & MIGRATION"], owners: ["Owner J"], labels: ["Priority:Medium"], status: "Executing", ordinal: 2 },
      { key: "DLV05-01", name: "Deliverable E1", streamKey: "STRM05", milestoneDate: 46220, phases: ["MANAGE"], owners: ["Owner A"], labels: ["Priority:Medium", "Risk:At-Risk"], status: "Executing", ordinal: 1 },
      { key: "DLV06-01", name: "Deliverable F1", streamKey: "STRM06", milestoneDate: 46259, phases: ["MODERNIZATION & MIGRATION"], owners: ["Owner G"], labels: ["Region:EU", "Risk:At-Risk"], status: "Backlog", ordinal: 1 },
      { key: "DLV07-01", name: "Deliverable G1", streamKey: "STRM07", milestoneDate: 46023, phases: ["DESIGN"], owners: ["Owner C"], labels: ["Priority:Low"], status: "Executing", ordinal: 1 },
      { key: "DLV08-01", name: "Deliverable H1", streamKey: "STRM08", milestoneDate: 46026, phases: ["STRATEGY"], owners: ["Owner E"], labels: [], status: "To Execute", ordinal: 1 },
      { key: "DLV09-01", name: "Deliverable I1", streamKey: "STRM09", milestoneDate: 46072, phases: ["MANAGE"], owners: ["Owner L"], labels: ["Region:EU"], status: "Executing", ordinal: 1 },
    ];
    ...
    const actionsData = [
      { key: "ACT01-01-01", name: "Action A1-1", deliverableKey: "DLV01-01", streamKey: "STRM01", status: "Executing", dueDate: 46367, effort: 7, owners: ["Owner E"], labels: ["Region:US", "Priority:Medium"], kanbanOrder: 1, ordinal: 1 },
      { key: "ACT01-01-02", name: "Action A1-2", deliverableKey: "DLV01-01", streamKey: "STRM01", status: "Executing", dueDate: 46404, effort: 4, owners: ["Owner I"], labels: ["Region:EU"], kanbanOrder: 2, ordinal: 2 },
      { key: "ACT01-01-03", name: "Action A1-3", deliverableKey: "DLV01-01", streamKey: "STRM01", status: "To Execute", dueDate: null, effort: 11, owners: ["Owner B"], labels: ["Priority:High"], kanbanOrder: 3, ordinal: 3 },
      { key: "ACT01-02-01", name: "Action A2-1", deliverableKey: "DLV01-02", streamKey: "STRM01", status: "Executing", dueDate: 46211, effort: 12, owners: ["Owner D"], labels: ["Risk:Normal"], kanbanOrder: 1, ordinal: 1 },
      { key: "ACT01-02-02", name: "Action A2-2", deliverableKey: "DLV01-02", streamKey: "STRM01", status: "Executing", dueDate: 46260, effort: 6, owners: ["Owner L"], labels: [], kanbanOrder: 2, ordinal: 2 },
      { key: "ACT02-01-01", name: "Action B1-1", deliverableKey: "DLV02-01", streamKey: "STRM02", status: "Backlog", dueDate: 46380, effort: 5, owners: ["Owner H"], labels: [], kanbanOrder: 1, ordinal: 1 },
      { key: "ACT02-01-02", name: "Action B1-2", deliverableKey: "DLV02-01", streamKey: "STRM02", status: "To Execute", dueDate: 46390, effort: 8, owners: ["Owner I"], labels: ["Priority:Low"], kanbanOrder: 2, ordinal: 2 },
      { key: "ACT02-02-01", name: "Action B2-1", deliverableKey: "DLV02-02", streamKey: "STRM02", status: "Done", dueDate: 46350, effort: 6, owners: ["Owner L"], labels: [], kanbanOrder: 1, ordinal: 1 },
      { key: "ACT03-01-01", name: "Action C1-1", deliverableKey: "DLV03-01", streamKey: "STRM03", status: "Executing", dueDate: 46260, effort: 10, owners: ["Owner F"], labels: ["Region:EU"], kanbanOrder: 1, ordinal: 1 },
      { key: "ACT03-01-02", name: "Action C1-2", deliverableKey: "DLV03-01", streamKey: "STRM03", status: "Blocked", dueDate: 46270, effort: 5, owners: ["Owner E"], labels: [], kanbanOrder: 2, ordinal: 2 },
      { key: "ACT04-01-01", name: "Action D1-1", deliverableKey: "DLV04-01", streamKey: "STRM04", status: "Executing", dueDate: 46235, effort: 8, owners: ["Owner E"], labels: [], kanbanOrder: 1, ordinal: 1 },
      { key: "ACT04-01-02", name: "Action D1-2", deliverableKey: "DLV04-01", streamKey: "STRM04", status: "Delegated", dueDate: null, effort: 4, owners: ["Owner C"], labels: ["Priority:High"], kanbanOrder: 2, ordinal: 2 },
      { key: "ACT05-01-01", name: "Action E1-1", deliverableKey: "DLV05-01", streamKey: "STRM05", status: "Executing", dueDate: 46225, effort: 7, owners: ["Owner A"], labels: [], kanbanOrder: 1, ordinal: 1 },
      { key: "ACT06-01-01", name: "Action F1-1", deliverableKey: "DLV06-01", streamKey: "STRM06", status: "Backlog", dueDate: 46265, effort: 6, owners: ["Owner G"], labels: [], kanbanOrder: 1, ordinal: 1 },
      { key: "ACT07-01-01", name: "Action G1-1", deliverableKey: "DLV07-01", streamKey: "STRM07", status: "Executing", dueDate: 46030, effort: 9, owners: ["Owner C"], labels: [], kanbanOrder: 1, ordinal: 1 },
    ];
    ...
    const stepsData = [
      { key: "STP01-01-01-01", name: "Step A1-1.1", actionKey: "ACT01-01-01", isDone: true, dueDate: 46370, owner: "Owner I" },
      { key: "STP01-01-01-02", name: "Step A1-1.2", actionKey: "ACT01-01-01", isDone: true, dueDate: 46369, owner: "Owner L" },
      { key: "STP01-01-01-03", name: "Step A1-1.3", actionKey: "ACT01-01-01", isDone: false, dueDate: null, owner: "Owner D" },
      { key: "STP01-01-02-01", name: "Step A1-2.1", actionKey: "ACT01-01-02", isDone: true, dueDate: null, owner: "Owner C" },
      { key: "STP01-01-02-02", name: "Step A1-2.2", actionKey: "ACT01-01-02", isDone: true, dueDate: 46414, owner: "Owner B" },
      { key: "STP01-01-02-03", name: "Step A1-2.3", actionKey: "ACT01-01-02", isDone: false, dueDate: 46399, owner: "Owner I" },
      { key: "STP01-02-01-01", name: "Step A2-1.1", actionKey: "ACT01-02-01", isDone: false, dueDate: null, owner: "Owner D" },
      { key: "STP01-02-01-02", name: "Step A2-1.2", actionKey: "ACT01-02-01", isDone: false, dueDate: 46217, owner: "Owner L" },
      { key: "STP01-02-01-03", name: "Step A2-1.3", actionKey: "ACT01-02-01", isDone: true, dueDate: 46218, owner: "Owner B" },
      { key: "STP02-01-01-01", name: "Step B1-1.1", actionKey: "ACT02-01-01", isDone: false, dueDate: 46385, owner: "Owner H" },
      { key: "STP02-01-01-02", name: "Step B1-1.2", actionKey: "ACT02-01-01", isDone: false, dueDate: null, owner: "Owner I" },
      { key: "STP03-01-01-01", name: "Step C1-1.1", actionKey: "ACT03-01-01", isDone: true, dueDate: 46265, owner: "Owner F" },
      { key: "STP03-01-01-02", name: "Step C1-1.2", actionKey: "ACT03-01-01", isDone: false, dueDate: 46268, owner: "Owner E" },
      { key: "STP04-01-01-01", name: "Step D1-1.1", actionKey: "ACT04-01-01", isDone: true, dueDate: 46240, owner: "Owner E" },
      { key: "STP04-01-01-02", name: "Step D1-1.2", actionKey: "ACT04-01-01", isDone: true, dueDate: 46238, owner: "Owner C" },
    ];
